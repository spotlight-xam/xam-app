...
class WebSocketController {
  ...
  private constructor(info: WebSocketConnectInfo) {
    this.webSocket = this._create(info);
  }
  static createInstance(info: WebSocketConnectInfo) {
    if (!WebSocketController._instance) {
      WebSocketController._instance = new WebSocketController(info);
    }
  ...
  private _create({ token, deviceToken, deviceName }: WebSocketConnectInfo) {
    const protocols =
